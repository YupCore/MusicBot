/**
 * Postinstall script: updates the root yt-dlp binary to the latest version.
...
const binary = process.platform === 'win32' ? windowsBinary : unixBinary;

if (!fs.existsSync(binary)) {
    console.log('ℹ️  Bin yt-dlp binary not found, skipping update.');
    process.exit(0);
}
